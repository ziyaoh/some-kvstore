...
type RegisterClientRequest struct {
	...
	IdempotencyID        uint64   `protobuf:"varint,2,opt,name=idempotencyID,proto3" json:"idempotencyID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RegisterClientRequest) GetIdempotent() bool {
	if m != nil {
		return m.Idempotent
	}
	return false
...
func (m *RegisterClientRequest) GetIdempotencyID() uint64 {
	if m != nil {
...
var fileDescriptor_251b44a0779aa6d6 = []byte{
	...
	,
}
